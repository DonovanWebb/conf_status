...
\subsection{State Preparation and Measurement}
    ...
    quote the measured state-preparation and measurement error (SPAM) of $\epsilon_{SPAM} = 1.46(6) e-3$.\\
...
\label{sec:Randomised Benchmarking}
    ...
    We measure the error per Clifford to be $\epsilon_c = 9.5(3)e-4$,
    while the SPAM error is $\epsilon_{SPAM} = 1.46(6) e-3$. The decay plot for
