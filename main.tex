...
\usepackage[style=numeric-comp, sorting=none, backend=biber, doi=false, isbn=false, url=false, date=year]{biblatex}
...
\title{Experimental apparatus for universal spin-motion control in multi-ion registers}
\author{Donovan Webb}
