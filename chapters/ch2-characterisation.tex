...
% Pre reqs:
    ...
    % Trap RF DC
    % Laser systems
    \mccorrect{XXX want a short introduction to the motion of the ion, and why we want to control it here.}
...
% Pre reqs:
    ...
    Doppler cooling exploits the fact that light incident on a moving ion will
