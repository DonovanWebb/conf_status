...
% Pre reqs:
    % High NA
    \mccorrect{XXX This section is not yet written. It will be a description of the imaging system, which is used to image the ion chain and collect fluorescence light for readout. It will include details on the camera, its properties, and the imaging optics.}
...
% Pre reqs:
    ...
    \begin{figure}[ht]
        ...
        729-nm. \mccorrect{XXX add zeeman sublevels for D5/2 and move this figure to characterisation section!}.
        }
